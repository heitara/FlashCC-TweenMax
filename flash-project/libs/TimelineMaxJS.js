...
// constructor
    ...
    function TimelineMaxJS(tweens, labels, props) {
        ...
        if (props&&props.position!=null) { this.setPosition(props.position, createjs.TweenMaxJS.NONE); }

    };

    var p = createjs.extend(TimelineMaxJS, createjs.EventDispatcher);
...
// public methods:
    ...
    p.removeTween = function(tween) {
        ...
        while (i--) {
            if (tweens[i] == tween) {
                tweens.splice(i, 1);
                //timeline
                this._timelineMax.remove(tween._timelineMax);
    ...
    p.addLabel = function(label, position) {
        ...
        this._timelineMax.addLabel(label, position);
    };
    ...
    p.setPosition = function(value, actionsMode) {
        //console.log("timeline max - setPostition");
     ...
     **/
    p.clone = function() {
        throw("TimelineMaxJS can not be cloned.")
    };
...
// private methods:
    ...
    createjs.TimelineMaxJS = createjs.promote(TimelineMaxJS, "EventDispatcher");
